...
contract StakingContract is ReentrancyGuard, Ownable(msg.sender) {
    ...
    uint256 public constant REWARD_RATE = 10; // 10 RWD per ETH per week
    ...
    function unstake() external nonReentrant {
        ...
        uint256 rewards = (userStake.ethAmount * REWARD_RATE * duration) / week; // Weekly rewards
